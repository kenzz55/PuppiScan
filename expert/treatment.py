...
with ruleset('pet_recommendation'):
    ...
    @when_all((m.lesion_type == 'A1') & (m.underlying_conditions == '내분비 이상'))
    ...
    @when_all((s.code == 'A2') & (s.cause == '알레르기성 피부염') & (s.age_group == 'puppy') & (s.weight_group == 'small'))
    def rec7(c):
